...
public class EndEffector extends SubsystemBase{
    ...
    private final double HORIZONTAL_ROLLER_GROUND_VOLTAGE = 0.6 * -12;

    private final double VERTICAL_ROLLER_STATION_VOLTAGE = 0.3 * -12;
    private final double HORIZONTAL_ROLLER_STATION_VOLTAGE = 0.45 * -12;
    ...
    private final double EJECT_SPEED = 1 * -12; //100% output
    ...
    public void feedUp(){
        verticalRoller.setControl(new VoltageOut(4));
    }
